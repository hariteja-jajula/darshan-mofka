...
set output 'deliverables/sample_iobench_1wl_walltime_mean_std.png'
...
plot 'deliverables/sample_iobench_1wl_walltime_mean_std.dat' using 2:3:xtic(1) lc rgb '#4c78a8'

set terminal svg size 900,560 enhanced font 'Arial,12'
set output 'deliverables/sample_iobench_1wl_walltime_mean_std.svg'
replot
